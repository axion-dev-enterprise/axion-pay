    ...
    <main className="pay-workspace min-h-screen bg-[#040806] px-5 py-8 text-[#f3f7f4] sm:px-8 lg:px-12">
      <div className="mx-auto max-w-7xl">
        ...
        <section className="py-16 lg:max-w-4xl">
          ...
          <h1 className="mt-4 text-4xl font-semibold tracking-tight text-white sm:text-5xl">Integre cobranças PIX em minutos.</h1>
          <p className="mt-5 max-w-2xl text-base leading-7 text-[#a1b0a6]">Use uma API idempotente, autenticada por merchant e operada no backend. Chaves privadas nunca devem chegar ao navegador.</p>
        ...
        <section className="mt-8 grid gap-6 rounded-2xl border border-[#213428] bg-[#050c08]/70 p-6 sm:p-8 lg:grid-cols-[1.2fr_1fr]">
          <div><p className="text-xs font-bold uppercase tracking-[0.18em] text-emerald-300">Cartão e assinaturas</p><h2 className="mt-3 text-2xl font-semibold text-white">Cobrança mensal via Stripe</h2><p className="mt-3 text-sm leading-6 text-[#a1b0a6]">No console, abra <a className="text-emerald-300 hover:underline" href="/dashboard">Plano & cobrança</a>. O botão “Assinar plano” redireciona para o Checkout Stripe; “Gerenciar assinatura” abre o Customer Portal. Os dados do cartão nunca passam pelo AXION.</p></div>
